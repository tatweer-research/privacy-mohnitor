...
def generate_model_outputs(models, tokenizer, input_text):
    ...
    if PT:
        ...
        results['pt'] = tokenizer.batch_decode(output_sequences, skip_special_tokens=False)
    return results


def generate_model_outputs_dataset(models, tokenizer, pglue_task="privacy_qa"):
    ...
    # inputs = [dataset_dict[DATASET][i]['text'] for i in range(32)]
...
if __name__ == '__main__':
    ...
    model_name = "/home/Mohammad.Al-Zoubi/privacy-mohnitor/instruction_finetuning/experiments/2023-09-03/privacy_qa/best_model/"
